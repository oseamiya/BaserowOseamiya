...
@DesignerComponent(version = 4,
    versionName="4.1",
    description = "Baserow is an open-source airtable alternative. This extension is developed and maintained by oseamiya. <br><a href=\"https://github.com/oseamiya/Baserow\">Source Code</a><br><a href=\"https://community.kodular.io/t/baserow-open-source-no-code-database/137886?u=oseamiya\">Documentation</a>",
    category = ComponentCategory.EXTENSION,
    nonVisible = true,
    helpUrl = "https://community.kodular.io/t/baserow-open-source-no-code-database/137886?u=oseamiya",
    iconName = "https://github.com/oseamiya/Baserow/raw/main/assets/icon.png")
@SimpleObject(external = true)
public class BaserowOseamiya extends AndroidNonvisibleComponent {
    ...
    public BaserowOseamiya(ComponentContainer container) {
